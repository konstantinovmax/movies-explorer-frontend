            ...
            <div className="about-me__content-container">
                <article className="about-me__text-container">
                    ...
                    <ul className="about-me__links-container">
                        <li><a href="https://www.facebook.com/konstantinovmax" className="about-me__link" target="_blank" rel="noreferrer">Facebook</a></li>
                        <li><a href="https://github.com/konstantinovmax" className="about-me__link" target="_blank" rel="noreferrer">Github</a></li>
                    </ul>
                </article>
