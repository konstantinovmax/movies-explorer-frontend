...
function AboutProject() {
    return (
        <section className="about-project">
            ...
            <div className="about-project__progress-bar-container about-project__progress-bar-container_type_one">
                <div className="about-project__progress-bar about-project__progress-bar_type_backend">
                    <p className="about-project__progress-bar-text about-project__progress-bar-text_type_black">1 неделя</p>
                </div>
                <div className="about-project__progress-bar about-project__progress-bar_type_frontend">
                    <p className="about-project__progress-bar-text about-project__progress-bar-text_type_white">4 недели</p>
                </div>
            </div>
            <div className="about-project__progress-bar-container">
                <div className="about-project__progress-bar about-project__progress-bar_type_backend-description">
                    <p className="about-project__progress-bar-text about-project__progress-bar-text_type_grey">Back-end</p>
                </div>
                <div className="about-project__progress-bar about-project__progress-bar_type_frontend-description">
                    <p className="about-project__progress-bar-text about-project__progress-bar-text_type_grey">Front-end</p>
                </div>
            </div>
        </section>
    );
